...
import { BrainCircuit } from "lucide-react"; // Import added here

export default function FloatingCards() {
  return (
    <motion.div
      whileHover={{ y: -3 }}
      className="relative p-4 bg-white/80 backdrop-blur-2xl border border-neutral-200 rounded-2xl overflow-hidden"
    >
